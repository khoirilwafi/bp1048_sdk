...
#define BT_NAME						"BP10_HPF_AEC_DEMO"
...
//DISABLE: only cvsd (8K)
//ENABLE: cvsd + msbc (16K)
#define BT_HFP_SUPPORT_WBS				DISABLE//DISABLE ENABLE//
...
#else
#define BT_HFP_AUDIO_DATA				HFP_AUDIO_DATA_PCM
#endif
...
//Note:如需SPP,则需要再增加协议栈RAM
 ...
 #define BT_STACK_MEM_SIZE			(30*1024+512+BT_AVRCP_TG_MEM_SIZE)
