...
typedef enum{
	 ...
	 *	or interrupt channel) has received the data
	 ...
	 *	The union params.hidData is valid and the data in hidData
...
bool HidAppInit(BTHidCallbackFunc callback);
