...
typedef enum _REVERB_ERROR_CODE
{
	...
	REVERB_ERROR_ILLEGAL_DRY_SCALE,
	REVERB_ERROR_ILLEGAL_WET_SCALE,
	REVERB_ERROR_ILLEGAL_WIDTH_SCALE,
	REVERB_ERROR_ILLEGAL_ROOMSIZE_SCALE,
	REVERB_ERROR_ILLEGAL_DAMP_SCALE,
