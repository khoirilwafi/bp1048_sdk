...
void QN8035SetFreq(uint16_t Frep)
{
	...
	///avoid the "POP" noise.
#ifdef FUNC_OS_EN
	osTaskDelay(CH_SETUP_DELAY_TIME);
#else
...
bool QN8035ReadID(void)
{
	...
	{
		APP_DBG("QN8035 ID : 0x84\n");
		//QN8035Init();
		return TRUE;
	}
	else
	{
		APP_DBG("QN8035 ID ERR : %d\n", (QNDReadReg(0x06) & 0xFC));
		return FALSE;
	}
//	QN8035Mute(TRUE);
}
...
//		else
//		{
//			//APP_DBG("QN8035 ID ERR : %BU\n",(QNDReadReg(0x06) & 0xFC));
//			//APP_DBG("QN8035 ID ERR : %2BX\n",(QNDReadReg(0x06) & 0xFC));
//			APP_DBG("QN8035 ID ERR :: %2BX\n",(QNDReadReg(0x06)));
//			//return FALSE;
